"""
Minimal NEXUS MNIST Test - No download, just training
"""
...
def generate_mnist_like_data(num_samples=1000):
    ...
    # Generate 28x28 grayscale images
...
def main():
    print("=" * 80)
    print("NEXUS Optimizer - Minimal MNIST Test")
    print("=" * 80)
    ...
    # Generate data
    print("Generating MNIST-like synthetic data...")
    X_train, y_train = generate_mnist_like_data(num_samples=5000)
    X_test, y_test = generate_mnist_like_data(num_samples=1000)
